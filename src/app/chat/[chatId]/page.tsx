...
const MessageBubble = ({ message, isOwnMessage }: { message: Message; isOwnMessage: boolean }) => {
  return (
    <div className={`flex items-end gap-2 ${isOwnMessage ? 'justify-end' : 'justify-start'}`}>
      ...
      <div
        className={`max-w-xs md:max-w-md rounded-2xl px-3 py-2 flex flex-col shadow-sm ${
          isOwnMessage
      ...
      >
        ...
        <p className={`text-xs mt-1 self-end ${isOwnMessage ? 'text-primary-foreground/70' : 'text-muted-foreground'}`}>
