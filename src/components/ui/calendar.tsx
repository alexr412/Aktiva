  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // HIER IST DER FIX: Grid statt Flex erzwingt 7 Spalten
        head_row: "grid grid-cols-7 mb-2",
        head_cell:
          "text-muted-foreground rounded-md w-9 font-normal text-[0.8rem] flex justify-center items-center",
        row: "grid grid-cols-7 w-full mt-2",
        cell: "h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 flex justify-center items-center",
        day: cn(
