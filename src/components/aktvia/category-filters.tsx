    ...
    <>
      ...
      <Dialog open={isConfigOpen} onOpenChange={setIsConfigOpen}>
        <DialogContent className="sm:max-w-md dark:bg-neutral-900">
          <DialogHeader>
            <DialogTitle className="font-black text-xl text-[#0f172a] dark:text-neutral-200">Kategorien anpassen</DialogTitle>
            <DialogDescription className="font-medium text-[#64748b] dark:text-neutral-400">
