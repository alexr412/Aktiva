  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={handleClose}>
      <DialogPrimitive.Portal>
        ...
        {isMobile ? (
          /* MOBILE (< md): Native Bottom Sheet */
          <DialogPrimitive.Content
            className={cn(
              'fixed inset-x-0 bottom-0 top-auto z-50',
              'w-full max-w-full outline-none shadow-2xl overflow-hidden',
          ...
          <DialogPrimitive.Content
            className={cn(
              ...
              'w-[calc(100vw-48px)] max-w-[540px] outline-none shadow-2xl overflow-hidden',
              'bg-white dark:bg-neutral-950 flex flex-col',
              'rounded-[24px]',
