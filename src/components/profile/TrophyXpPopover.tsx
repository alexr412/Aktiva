...
function TrophyXpContent({ isDe, onClose }: { isDe: boolean; onClose: () => void }) {
  return (
    <>
      {/* Header */}
      <div className="shrink-0 bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-cyan-500/10 dark:from-emerald-500/20 dark:via-teal-500/20 dark:to-cyan-500/20 p-4 pb-3 border-b border-slate-100 dark:border-neutral-800 relative">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="h-7 w-7 rounded-full bg-slate-100 dark:bg-neutral-800 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 flex items-center justify-center transition-colors cursor-pointer"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-4 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-neutral-300 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-700/80 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-emerald-500/60 transition-colors">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-2.5 p-2.5 rounded-2xl bg-slate-50/80 dark:bg-neutral-800/50 border border-slate-100 dark:border-neutral-800/80">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="font-black text-[10px] text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 px-2 py-0.5 rounded-lg shrink-0">
                    +10 XP
                  </span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-neutral-400 mt-0.5 leading-snug">
            ...
            <div className="flex items-start gap-2.5 p-2.5 rounded-2xl bg-slate-50/80 dark:bg-neutral-800/50 border border-slate-100 dark:border-neutral-800/80">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="font-black text-[10px] text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-950/60 px-2 py-0.5 rounded-lg shrink-0">
                    +20 XP
                  </span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-neutral-400 mt-0.5 leading-snug">
            ...
            <div className="flex items-start gap-2.5 p-2.5 rounded-2xl bg-slate-50/80 dark:bg-neutral-800/50 border border-slate-100 dark:border-neutral-800/80">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="font-black text-[10px] text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/60 px-2 py-0.5 rounded-lg shrink-0">
                    +50 XP
                  </span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-neutral-400 mt-0.5 leading-snug">
            ...
            <div className="flex items-start gap-2.5 p-2.5 rounded-2xl bg-slate-50/80 dark:bg-neutral-800/50 border border-slate-100 dark:border-neutral-800/80">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="font-black text-[10px] text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-950/60 px-2 py-0.5 rounded-lg shrink-0">
                    +25 XP
                  </span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-neutral-400 mt-0.5 leading-snug">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            <div className="p-3 rounded-2xl bg-indigo-50/40 dark:bg-indigo-950/20 border border-indigo-100/60 dark:border-indigo-900/30 flex items-start gap-2.5">
              <Crown className="h-4 w-4 text-amber-500 shrink-0 mt-0.5" />
              <div className="flex-1 min-w-0">
                <span className="font-bold text-xs text-slate-800 dark:text-neutral-200 block">
                  {isDe ? 'Exklusive Rang-Titel' : 'Exclusive Rank Titles'}
                </span>
                <p className="text-[11px] text-slate-600 dark:text-neutral-400 leading-snug mt-0.5">
                  {isDe 
            ...
            <div className="p-3 rounded-2xl bg-teal-50/40 dark:bg-teal-950/20 border border-teal-100/60 dark:border-teal-900/30 flex items-start gap-2.5">
      ...
      {/* Footer / Wallet Link */}
      <div className="shrink-0 p-3 px-4 bg-slate-50 dark:bg-neutral-900/80 border-t border-slate-100 dark:border-neutral-800 flex items-center justify-between text-xs">
