...
export function FeaturedPlaceCard({
    ...
    return (
        <article
            ...
            className={cn(
                "cursor-pointer group overflow-hidden rounded-[22px] bg-white dark:bg-neutral-900 border border-slate-200/40 dark:border-neutral-800/60 shadow-premium hover:shadow-premium-active transition-[transform,box-shadow,border-color] duration-200 flex flex-row relative p-0 w-full min-w-0 min-h-[145px] max-h-[165px] md:max-h-none md:min-h-[160px]",
        ...
        >
            ...
            <div className="p-3 md:p-5 flex flex-col flex-1 min-w-0 justify-between">
                <div className="min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1 md:mb-2 min-w-0">
                        <div className="min-w-0 flex-1">
                            <h3 className="text-sm sm:text-base md:text-lg font-black tracking-tight leading-tight text-[#0f172a] dark:text-neutral-200 truncate flex items-center gap-1.5 min-w-0">
                                <button
                                    onClick={(e) => { e.stopPropagation(); onClick(); }}
                                    className="font-black text-sm sm:text-base md:text-lg text-left text-[#0f172a] dark:text-neutral-200 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded truncate block"
                                >
                            ...
                            <div className="flex items-center gap-1.5 text-neutral-400 dark:text-neutral-500 font-bold text-[9px] md:text-[10px] mt-0.5 min-w-0">
                                {place.openingHours ? (
                    ...
                    <div className="hidden md:flex flex-wrap gap-1 mb-4 max-w-full">
                ...
                {/* Footer Controls */}
                <div className="flex items-center justify-between gap-1.5 md:gap-2 mt-1 md:mt-auto pt-1.5 md:pt-3 border-t border-slate-50 dark:border-neutral-800/40 max-w-full">
                    ...
                    <div className="flex items-center gap-1 shrink-0 ml-auto">
                        <Button
                            ...
                            className={cn(
                                "h-8 w-8 md:h-8 md:w-8 rounded-xl transition-colors duration-200 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2",
